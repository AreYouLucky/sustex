...
const Flipbook = memo(({ viewerStates, setViewerStates, flipbookRef, pdfDetails }) => {
    ...
    return (
        <div ref={ref} className={cn("relative h-[92vh] w-full bg-transparent flex justify-center items-center overflow-hidden", screenfull?.isFullscreen && 'h-[calc(100vh-5.163rem)] xs:h-[calc(100vh-5.163rem)] lg:h-[calc(100vh-5.163rem)] xl:h-[calc(100vh-4.66rem)]')}>
